...
export default function RegisterPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              className="w-full px-3 py-2 border border-input rounded-md bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary pr-10"
              placeholder="••••••••"
            />
            <button
              type="button"
      ...
      <button
        type="button"
        className="w-full py-2.5 border border-border rounded-md font-medium hover:bg-muted transition-colors flex items-center justify-center gap-2"
      >
